...
class StockGUI:
    def __init__(self, guiWin, api_key):
        ...
        self.s1 = IntVar()
        self.s1.set(0)
        self.sc1 = ttk.Checkbutton(self.stock_frame, text="IBM", 
                                  variable=self.s1, command=self.stock1, 
                                  onvalue=1, offvalue=0).\
                                  grid(column=1, row=1, sticky=W)
        self.s2 = IntVar()
        self.s2.set(0)
        self.sc2 = ttk.Checkbutton(self.stock_frame, text="Apple", 
                                  variable=self.s2, command=self.stock2, 
                                  onvalue=1, offvalue=0).\
                                  grid(column=1, row=2, sticky=W) 
        self.s3 = IntVar()
        self.s3.set(0)
        self.sc3 = ttk.Checkbutton(self.stock_frame, text="Microsoft", 
                                  variable=self.s3, command=self.stock3, 
                                  onvalue=1, offvalue=0).\
                                  grid(column=1, row=3, sticky=W) 
        self.s4 = IntVar()
        self.s4.set(0)
        self.sc4 = ttk.Checkbutton(self.stock_frame, text="Moderna", 
                                  variable=self.s4, command=self.stock4, 
                                  onvalue=1, offvalue=0).\
                                  grid(column=1, row=4, sticky=W)
        self.s5 = IntVar()
        self.s5.set(0)
        self.sc5 = ttk.Checkbutton(self.stock_frame, text="Pfizer", 
                                  variable=self.s5, command=self.stock5, 
                                  onvalue=1, offvalue=0).\
                                  grid(column=1, row=5, sticky=W) 
        self.s6 = IntVar()
        self.s6.set(0)
        self.sc6 = ttk.Checkbutton(self.stock_frame, text="Novavax", 
                                  variable=self.s6, command=self.stock6, 
                                  onvalue=1, offvalue=0).\
                                  grid(column=1, row=6, sticky=W)
        self.s7 = IntVar()
        self.s7.set(0)
        self.sc7 = ttk.Checkbutton(self.stock_frame, text="AstraZeneca", 
    ...
    def clear_entries(self):
        ...
        self.imgwin = ttk.Label(self.mainframe, text=""). \
                        grid(column=1, row=4, columnspan=8, sticky=W)
